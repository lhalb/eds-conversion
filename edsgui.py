...
class Ui_edxKonverter(object):
    def setupUi(self, edxKonverter):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/chart.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.but_process.setMinimumSize(QtCore.QSize(170, 170))
        self.but_process.setMaximumSize(QtCore.QSize(190, 190))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/file.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
